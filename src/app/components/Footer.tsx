    ...
    return (
        <footer className="relative w-full h-[100dvh] pt-20 md:pt-32 bg-gradient-to-b from-[#8a0a0a] to-[#4a0e0e] text-white overflow-hidden mt-0 flex flex-col justify-between">
            <div className="w-full h-full max-w-[1500px] mx-auto px-6 md:px-12 relative z-10 flex flex-col justify-between mt-4">
                ...
                {/* Main Content Area */}
                <div className="w-full flex justify-between gap-16 lg:gap-8 mb-20 md:mb-22 z-10 flex-col md:flex-row">
                ...
                <div className="w-full flex flex-col md:flex-row items-center justify-between gap-6 text-[11px] md:text-[12px] font-[var(--font-dm-sans)] text-white/70 mb-70 z-10 relative">
                    <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-center text-center md:text-left">
                        ...
                        <span>Partner with us: hello@raseshvari.com</span>
                    </div>
                ...
                <div className="absolute left-0 bottom-0 w-full overflow-hidden flex justify-center translate-y-[35%] md:translate-y-[20%] select-none pointer-events-none z-0 px-4">
