...
export default function ScrollPoints() {
    return (
        <section className="h-screen bg-gradient-to-b from-[#4a0e0e] via-[#7a1a1a] to-[#9b1c1c] flex flex-col relative overflow-hidden">
            ...
            <div className="flex-shrink-0 relative z-10 px-6 md:px-12 pb-5 pt-2">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-white/50 text-xs md:text-sm italic font-[var(--font-playfair)]">
