...
const photos: { src: string; alt: string; caption: string; aspect: string }[] = [
    ...
    { src: "/journey/Anchor sadhna Shrivastav.png", alt: "Anchor Sadhna Shrivastava", caption: "DD News reader Sadhana Srivastava ji", aspect: "3/4" },
    { src: "/journey/Salma sultan.png", alt: "Actor Salma Sultan ji", caption: "Legendary Doordarshan Anchor Salma Sultan ji", aspect: "3/4" },
    { src: "/journey/Sonal Mansingh.png", alt: "Classical Dancer Sonal Mansingh ji", caption: "Padma Vibhushan, Sonal Mansingh ji", aspect: "3/4" },
    ...
    { src: "/journey/Artist monika gour png.png", alt: "Artist Monica Gaur", caption: "Poetess Monika Gaur ji", aspect: "3/4" },
