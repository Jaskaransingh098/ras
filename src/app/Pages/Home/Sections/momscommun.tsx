...
export default function MomsCommunity() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-[70dvh] max-h-[100dvh] flex flex-col items-center justify-center overflow-hidden py-16 px-6 md:px-12 bg-white"
    >
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
        {/* Left Content Area */}
        <div className="mc-reveal w-full md:w-[40%] flex flex-col items-start">
          ...
          <h2 className="section-heading font-[var(--font-playfair)] text-[#111] font-bold tracking-tight mb-5">
            <span className="block text-[28px] md:text-[28px] leading-none">
              MOMS
            </span>
            <span className="block font-semibold text-[20px] leading-none">
              (Multitasking Outstanding Mothers Space)
            </span>
            <span className="block italic font-bold text-[#c42d2d] text-[28px] md:text-[28px] leading-none">
              COMMUNITY
            </span>
          </h2>
        ...
        <div className="mc-reveal w-full md:w-[70%] h-[400px] md:h-[700px] flex gap-3 overflow-hidden rounded-2xl md:rounded-3xl relative ">
          {/* Fade top/bottom */}
