...
export default function MomsCommunity() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-auto md:min-h-[70dvh] rounded-2xl flex flex-col items-center justify-center overflow-hidden py-5 px-3 sm:px-4 md:px-6 bg-[#4a0e0e]/8"
    >
