...
export default function Hero() {
  ...
  return (
    <section className="grid md:grid-cols-2 gap-12 ">
      {/* LEFT SIDE */}
      <div
        className="relative h-[82vh] bg-[#feebfb]
 rounded-3xl px-16 py-16 flex flex-col justify-between shadow-xl border border-[#e7e2d9] mt-28"
      >
        ...
        <div>
          ...
          {/* CTA */}
          <button className="mt-8 flex items-center bg-[#d03737] text-white rounded-full px-6 py-3  shadow-md hover:scale-105 transition-all duration-300">
            <span className="mr-4 text-sm tracking-wide">
              Book Your Diagnostic Call
            </span>

            <span className="bg-[#ffffff] text-black w-8 h-8 flex items-center justify-center rounded-full">
              →
            </span>
          </button>
        </div>
